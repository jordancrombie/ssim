...
/**
 * SSIM E2E Test Configuration
 *
 * Tests the SSIM checkout flows including:
 * - Pay with BSIM (bank direct)
 * - Wallet Popup, Inline, Redirect (OIDC flows)
 * - Wallet API, API Direct, API Proxy (Merchant API flows)
 *
